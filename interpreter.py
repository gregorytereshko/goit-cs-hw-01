...
class Parser:
    ...
    def factor(self):
        """
        Парсер для 'factor' правил граматики. Включає числа і вирази в дужках.
        """
    ...
    def term(self):
        """
        Парсер для 'term' правил граматики. Включає множення і ділення.
        """
        node = self.factor()
    ...
    def expr(self):
        """
        Парсер для арифметичних виразів. Включає додавання і віднімання.
        """
        node = self.term()
